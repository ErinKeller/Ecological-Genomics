...
workingDir = "."; # no need to do this
setwd(workingDir); # no need to do this
setwd("~/Dropbox/2_Teaching/WGCNA/tutorial") # no need to do this
setwd("~/Dropbox/1_Research/SSW/DGE/WGCNA") # no need to do this
...
datExpr0 = as.data.frame(t(femData[, -c(1:8)])); # example of code for liver data
dim(datExpr0)
...
gsg = goodSamplesGenes(datExpr0, verbose = 3); # rat liver data example
gsg$allOK
